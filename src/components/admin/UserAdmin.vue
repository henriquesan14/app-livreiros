<template>
    <div class="user-admin">
        <router-link v-hasRole="'ESCREVER_USUARIO'"  class="btn btn-dark btn-sm mb-2" tag="b-button" to="/dashboard/usuarios/cadastro" ><i class="fa fa-plus-circle mr-1"></i>Novo usuário</router-link>
        <b-row>
            <b-col md="12" sm="12" class="mb-3">
                <b-input-group>
                    <b-form-input size="sm" v-model="nome" @keydown.enter="getUsers()" type="text" placeholder="Pesquise o nome do usuário..." />
                    <b-input-group-append>
                        <b-button size="sm" @click="getUsers()" variant="primary"><i class="fa fa-search"></i></b-button>
                    </b-input-group-append>
                </b-input-group>
            </b-col>
        </b-row>
